...
public class EmployeeController {
   ...
   @PostMapping
   public Employee createEmployee(@RequestBody Employee employee){ //injeção de object
      return employeeRepository.save(employee);
   }

   //build get employee by id REST API
   @GetMapping("{id}")
   public ResponseEntity<Employee> getEmployeeById(@PathVariable long id){//path pegando o id
